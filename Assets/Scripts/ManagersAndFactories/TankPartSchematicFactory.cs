...
{
    public static HullPartSchematic CreateHullPartSchematic(string name, int armour, int energyPower, Vector2 size, int weight, float angularDrag, Vector2[] weaponDirs, Vector2[] weaponPos, int[] weightRestrict) {
        return new HullPartSchematic(name, armour, energyPower, size, weight, angularDrag, weaponDirs, weaponPos, weightRestrict);
    }
