...
{
    public static HullPartSchematic CreateHullPartSchematic(string name, int armour, Vector2 size, int energyPower, int weight, Vector2[] weaponDirs, Vector2[] weaponFireOffset, int[] weightRestrict) {
        return new HullPartSchematic(name, armour, size, energyPower, weight, weaponDirs, weaponFireOffset, weightRestrict);
    }
